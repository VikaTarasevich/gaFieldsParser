const fulledEntities = {
    "kind": "analytics#columns",
    "etag": "\"7ltHYUHpRX0SoDWoiLFPEO_2id4/PzHPLrWjzswAxb7y6pVwl4xQOnk\"",
    "totalResults": 552,
    "attributeNames": ["replacedBy", "type", "dataType", "group", "status", "uiName", "appUiName", "description", "calculation", "minTemplateIndex", "maxTemplateIndex", "premiumMinTemplateIndex", "premiumMaxTemplateIndex", "allowedInSegments", "addedInApiVersion"],
    "items": [{
        "id": "ga:userType",
        ...
        "kind": "analytics#column",
        "attributes": {
            "replacedBy": "ga:uniqueDimensionCombinations",
            "type": "METRIC",
            "dataType": "INTEGER",
            "group": "Event Tracking",
            "status": "DEPRECATED",
            "uiName": "Unique Dimension Combinations",
            "description": "The definition of `ga:uniqueEvents` will change soon to more accurately reflect the number of unique events. Please use `ga:uniqueDimensionCombinations` instead if you want to retain the existing definition. For more information, see https://support.google.com/analytics/answer/7084499.",
            "addedInApiVersion": "3"
        }
    }, {
        "id": "ga:eventValue",
